const translations = {
  en: {
    ...
    "hero.title1": "AI Co-Pilot for",
    "hero.title2": "Stadium Volunteers.",
    "hero.subtitle": "Real-time crowd intelligence and multilingual guidance for under-trained volunteers managing diverse crowds at the FIFA World Cup 2026™ — know what to do, in your language, right now.",
    ...
    "dash.volunteer.copilot": "Open Co-Pilot →",
    ...
    "copilot.nav": "Co-Pilot",
    "copilot.title": "Volunteer ",
    "copilot.title_span": "Co-Pilot",
    "copilot.subtitle": "Real-time crowd intelligence in your language. Know what to do, right now.",
    "copilot.refresh": "Refresh",
    "copilot.action_title": "What should I do right now?",
    "copilot.action_subtitle": "AI-recommended action for your zone",
    "copilot.action_loading": "Analyzing your zone…",
    "copilot.status.awaiting": "Awaiting analysis",
    "copilot.status.optimal": "Optimal",
    "copilot.status.moderate": "Moderate",
    "copilot.status.congested": "Congested",
    "copilot.status.critical": "Critical",
    "copilot.zones_title": "Zone Status",
    "copilot.insights_title": "AI Insights",
    "copilot.insights_loading": "Loading insights…",
    "copilot.routing_title": "Gate Routing",
    "copilot.routing_loading": "Loading routing advice…",
    "copilot.global_title": "Global Stadium Status",
    "copilot.weather_title": "Weather",
    "copilot.weather_loading": "Loading weather…",
    "copilot.quick_title": "Quick Actions",
    "copilot.open_map": "🗺️ Open Live Map",
    "copilot.open_hub": "🤝 Volunteer Hub",
    "copilot.predictions_title": "Zone Predictions (15 min)",
    "copilot.predictions_loading": "Loading predictions…",
    "copilot.analyzing": "AI is analyzing your zone…",
    "copilot.error": "Failed to load analysis. Tap Refresh to try again."
  },
  es: {
    ...
    "hero.title1": "Co-Piloto IA para",
    "hero.title2": "Voluntarios del Estadio.",
    "hero.subtitle": "Inteligencia de multitudes en tiempo real y orientación multilingüe para voluntarios que gestionan multitudes diversas en la Copa Mundial de la FIFA 2026™ — sabe qué hacer, en tu idioma, ahora.",
    ...
    "dash.volunteer.copilot": "Abrir Co-Piloto →",
    ...
    "copilot.nav": "Co-Piloto",
    "copilot.title": "Voluntario ",
    "copilot.title_span": "Co-Piloto",
    "copilot.subtitle": "Inteligencia de multitudes en tu idioma. Sabe qué hacer, ahora.",
    "copilot.refresh": "Actualizar",
    "copilot.action_title": "¿Qué debo hacer ahora?",
    "copilot.action_subtitle": "Acción recomendada por IA para tu zona",
    "copilot.action_loading": "Analizando tu zona…",
    "copilot.status.awaiting": "Esperando análisis",
    "copilot.status.optimal": "Óptimo",
    "copilot.status.moderate": "Moderado",
    "copilot.status.congested": "Congestionado",
    "copilot.status.critical": "Crítico",
    "copilot.zones_title": "Estado de Zonas",
    "copilot.insights_title": "Análisis IA",
    "copilot.insights_loading": "Cargando análisis…",
    "copilot.routing_title": "Enrutamiento de Puertas",
    "copilot.routing_loading": "Cargando consejos de rutas…",
    "copilot.global_title": "Estado Global del Estadio",
    "copilot.weather_title": "Clima",
    "copilot.weather_loading": "Cargando clima…",
    "copilot.quick_title": "Acciones Rápidas",
    "copilot.open_map": "🗺️ Ver Mapa en Vivo",
    "copilot.open_hub": "🤝 Centro de Voluntarios",
    "copilot.predictions_title": "Predicciones de Zonas (15 min)",
    "copilot.predictions_loading": "Cargando predicciones…",
    "copilot.analyzing": "La IA está analizando tu zona…",
    "copilot.error": "Error al cargar análisis. Toca Actualizar para intentar de nuevo."
  },
  fr: {
    ...
    "hero.title1": "Co-Pilote IA pour",
    "hero.title2": "Bénévoles du Stade.",
    "hero.subtitle": "Intelligence des foules en temps réel et orientation multilingue pour les bénévoles gérant les foules diverses à la Coupe du Monde de la FIFA 2026™ — savoir quoi faire, dans votre langue, maintenant.",
    ...
    "dash.volunteer.copilot": "Ouvrir le Co-Pilote →",
    ...
    "copilot.nav": "Co-Pilote",
    "copilot.title": "Bénévole ",
    "copilot.title_span": "Co-Pilote",
    "copilot.subtitle": "Intelligence des foules en temps réel dans votre langue. Savoir quoi faire, maintenant.",
    "copilot.refresh": "Actualiser",
    "copilot.action_title": "Que dois-je faire maintenant?",
    "copilot.action_subtitle": "Action recommandée par l'IA pour votre zone",
    "copilot.action_loading": "Analyse de votre zone…",
    "copilot.status.awaiting": "En attente d'analyse",
    "copilot.status.optimal": "Optimal",
    "copilot.status.moderate": "Modéré",
    "copilot.status.congested": "Congestionné",
    "copilot.status.critical": "Critique",
    "copilot.zones_title": "État des Zones",
    "copilot.insights_title": "Analyses IA",
    "copilot.insights_loading": "Chargement des analyses…",
    "copilot.routing_title": "Acheminement Portes",
    "copilot.routing_loading": "Chargement des conseils…",
    "copilot.global_title": "État Global du Stade",
    "copilot.weather_title": "Météo",
    "copilot.weather_loading": "Chargement météo…",
    "copilot.quick_title": "Actions Rapides",
    "copilot.open_map": "🗺️ Ouvrir la Carte",
    "copilot.open_hub": "🤝 Hub Bénévoles",
    "copilot.predictions_title": "Prédictions Zones (15 min)",
    "copilot.predictions_loading": "Chargement des prédictions…",
    "copilot.analyzing": "L'IA analyse votre zone…",
    "copilot.error": "Échec du chargement. Appuyez sur Actualiser pour réessayer."
  },
  ar: {
    ...
    "hero.title1": "مساعد ذكاء اصطناعي لـ",
    "hero.title2": "متطوعي الملعب.",
    "hero.subtitle": "ذكاء الحشود في الوقت الفعلي وإرشادات متعددة اللغات للمتطوعين الذين يديرون الحشود المتنوعة في كأس العالم لكرة القدم 2026™ — اعرف ماذا تفعل، بلغتك، الآن.",
    ...
    "dash.volunteer.copilot": "فتح مساعد الطيار ←",
    ...
    "copilot.nav": "مساعد الطيار",
    "copilot.title": "متطوع ",
    "copilot.title_span": "مساعد الطيار",
    "copilot.subtitle": "ذكاء الحشود بلغتك في الوقت الفعلي. اعرف ماذا تفعل، الآن.",
    "copilot.refresh": "تحديث",
    "copilot.action_title": "ماذا يجب أن أفعل الآن؟",
    "copilot.action_subtitle": "إجراء مقترح من الذكاء لمنطقتك",
    "copilot.action_loading": "جاري تحليل منطقتك…",
    "copilot.status.awaiting": "بانتظار التحليل",
    "copilot.status.optimal": "مثالي",
    "copilot.status.moderate": "متوسط",
    "copilot.status.congested": "مزدحم",
    "copilot.status.critical": "حرج",
    "copilot.zones_title": "حالة المناطق",
    "copilot.insights_title": "رؤى الذكاء",
    "copilot.insights_loading": "جاري تحميل الرؤى…",
    "copilot.routing_title": "توجيه البوابات",
    "copilot.routing_loading": "جاري تحميل نصائح التوجيه…",
    "copilot.global_title": "الحالة العامة للملعب",
    "copilot.weather_title": "الطقس",
    "copilot.weather_loading": "جاري تحميل الطقس…",
    "copilot.quick_title": "إجراءات سريعة",
    "copilot.open_map": "🗺️ فتح الخريطة الحية",
    "copilot.open_hub": "🤝 مركز المتطوعين",
    "copilot.predictions_title": "توقعات المناطق (15 دقيقة)",
    "copilot.predictions_loading": "جاري تحميل التوقعات…",
    "copilot.analyzing": "الذكاء يحلل منطقتك…",
    "copilot.error": "فشل في تحميل التحليل. اضغط تحديث للمحاولة مرة أخرى."
  },
  hi: {
    ...
    "hero.title1": "स्टेडियम स्वयंसेवकों के लिए",
    "hero.title2": "एआई सह-पायलट।",
    "hero.subtitle": "फीफा विश्व कप 2026™ में विविध भीड़ का प्रबंधन करने वाले स्वयंसेवकों के लिए रीयल-टाइम भीड़ बुद्धिमत्ता और बहुभाषी मार्गदर्शन — जानें क्या करना है, अपनी भाषा में, अभी।",
    ...
    "dash.volunteer.copilot": "सह-पायलट खोलें →",
    ...
    "copilot.nav": "सह-पायलट",
    "copilot.title": "स्वयंसेवक ",
    "copilot.title_span": "सह-पायलट",
    "copilot.subtitle": "आपकी भाषा में रीयल-टाइम भीड़ बुद्धिमत्ता। जानें क्या करना है, अभी।",
    "copilot.refresh": "रीफ्रेश",
    "copilot.action_title": "अभी मुझे क्या करना चाहिए?",
    "copilot.action_subtitle": "आपके क्षेत्र के लिए एआई-सुझाया गया कार्य",
    "copilot.action_loading": "आपके क्षेत्र का विश्लेषण हो रहा है…",
    "copilot.status.awaiting": "विश्लेषण की प्रतीक्षा",
    "copilot.status.optimal": "इष्टतम",
    "copilot.status.moderate": "मध्यम",
    "copilot.status.congested": "भीड़भाड़",
    "copilot.status.critical": "गंभीर",
    "copilot.zones_title": "क्षेत्र की स्थिति",
    "copilot.insights_title": "एआई अंतर्दृष्टि",
    "copilot.insights_loading": "अंतर्दृष्टि लोड हो रही है…",
    "copilot.routing_title": "गेट रूटिंग",
    "copilot.routing_loading": "रूटिंग सलाह लोड हो रही है…",
    "copilot.global_title": "स्टेडियम की समग्र स्थिति",
    "copilot.weather_title": "मौसम",
    "copilot.weather_loading": "मौसम लोड हो रहा है…",
    "copilot.quick_title": "त्वरित कार्रवाई",
    "copilot.open_map": "🗺️ लाइव मैप खोलें",
    "copilot.open_hub": "🤝 स्वयंसेवक हब",
    "copilot.predictions_title": "क्षेत्र पूर्वानुमान (15 मिनट)",
    "copilot.predictions_loading": "पूर्वानुमान लोड हो रहे हैं…",
    "copilot.analyzing": "एआई आपके क्षेत्र का विश्लेषण कर रहा है…",
    "copilot.error": "विश्लेषण लोड करने में विफल। पुनः प्रयास करने के लिए रीफ्रेश दबाएं।"
  }
};
